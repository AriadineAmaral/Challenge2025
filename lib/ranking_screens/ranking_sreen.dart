...
class _RankingScreenState extends State<RankingScreen> {
  ...
  // Método para determinar se é uma tela grande (tablet/desktop)
  bool _isLargeScreen(BuildContext context) {
    return MediaQuery.of(context).size.width >= 1072; // A partir de 1072px
  }
  ...
  Widget build(BuildContext context) {
    ...
    // Conteúdo principal que será reutilizado
    Widget content = SingleChildScrollView(
      child: Center(
        child: ConstrainedBox(
          constraints: BoxConstraints(
            maxWidth: kIsWeb ? 1072 : 600, // Limita a largura máxima
          ),
          child: Padding(
    ...
    if (isLargeScreen) {
      return Scaffold(
        ...
        appBar: AppBar(
          ...
          automaticallyImplyLeading: false, // Não mostra ícone do drawer
        ),
        body: Stack(
          children: [
            TitleAndDrawer(),
        ...
        bottomNavigationBar: null, // Sem footer em telas grandes
      );
    }

    // Layout para telas pequenas (com drawer normal)
    return Scaffold(
      backgroundColor: Colors.white,
      appBar: AppBar(
        centerTitle: true,
      ...
      bottomNavigationBar: Footer(), // COM footer em telas pequenas
    );
  }
}
